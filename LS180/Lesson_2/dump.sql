...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: raydiator
--
...
ALTER TABLE public.weather OWNER TO raydiator;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: raydiator
--
