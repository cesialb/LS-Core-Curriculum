...
---
**Problem Domain:**
- Only one value in the array appears twice
---
...
- Output value is (assuming) an integer
...
- Iterate through array, accessing each element
  - If the element next to it is the same, return this element
...
def find_dup(array)
  array.sort.each_with_index do |number, idx|
    return number if number == array.sort[idx + 1]
  end
end
